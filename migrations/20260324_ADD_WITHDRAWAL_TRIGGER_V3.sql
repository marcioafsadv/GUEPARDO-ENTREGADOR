-- ====================================================================
-- GUEPARDO: TRIGGER DE BLOQUEIO DE SALDO (ANTECIPAÇÃO) - V3 (FINAL)
-- ====================================================================
-- Corrigido: Cast explícito de ::date e ::time para compatibilidade
-- com os tipos de coluna nativos do PostgreSQL.
...
BEGIN
    INSERT INTO public.transactions (
        ...
        (NEW.created_at AT TIME ZONE 'UTC' AT TIME ZONE 'America/Sao_Paulo')::time, -- Cast obrigatório para ::time
        'current' 
    );
    RETURN NEW;
END;
