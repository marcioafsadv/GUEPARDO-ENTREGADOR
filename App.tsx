...
: null
            ...
            {(!isNavigating) && (
              <div className={`absolute right-5 sm:right-6 bottom-[9.5rem] sm:bottom-[10.5rem] z-[1020] flex flex-col space-y-3.5 transition-all duration-700 ${isResumoExpanded ? '-translate-y-[17rem] sm:-translate-y-[26rem]' : 'translate-y-0'} animate-in fade-in slide-in-from-right-8`}>
            ...
            {status !== DriverStatus.ALERTING && !mission && !isNavigating && (
              <div className={`absolute bottom-20 sm:bottom-24 left-0 right-0 z-[1010] transition-all duration-700 transform ${isResumoExpanded ? 'translate-y-0' : 'translate-y-[calc(100%-4rem)]'}`}>
