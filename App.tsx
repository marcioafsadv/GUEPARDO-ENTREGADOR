...
: null
            ...
            {status !== DriverStatus.ALERTING && !mission && !isNavigating && (
              <div className={`absolute bottom-16 sm:bottom-24 left-0 right-0 z-[1010] transition-all duration-700 transform ${isResumoExpanded ? 'translate-y-0' : 'translate-y-[calc(100%-3.5rem)]'}`}>
