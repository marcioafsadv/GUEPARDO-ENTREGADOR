...
: null
            ...
            {status !== DriverStatus.ALERTING && !mission && !isNavigating && (
              <div className={`absolute bottom-[5.2rem] sm:bottom-24 left-0 right-0 z-[1010] transition-all duration-700 transform ${isResumoExpanded ? 'translate-y-0' : 'translate-y-[calc(100%-4rem)]'}`}>
